...
class DataTypes:
    ...
    my_integer: int = 1_337_911                 # ❤️❤️❤️❤️❤️
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Error: {e}")            # Error: object of type 'int' has no len()
    finally:
        print("Finshed to end")
```
...
type(x)	                x.__class__             # ❤️❤️❤️❤️❤️
len(x)	                x.__len__()
str(x)	                x.__str__()             # ❤️❤️❤️❤️❤️
repr(x)	                x.__repr__()
hash(x)	                x.__hash__()
x + y	                x.__add__(y)
x - y	                x.__sub__(y)
...
# Learn mutable: bytearray, list, dict, set ❤️❤️❤️❤️❤️
...
# Side Quest: Math
```python
print(5/3)              # Float Division ❤️❤️❤️❤️❤️
...
>>> 3.5.__round__()                     # () means call ❤️❤️❤️❤️❤️
4 
