...
# Side Quest: Higher Lower Guessing Game
```python
import random
data = [
  {
...
if __name__ == "__main__":    
    ...
    while not game_over:
        ...
        # print(person_1)                               # DEBUG: {'name': '9GAG', 'follower_count': 52, 'description': 'Social media platform', 'country': 'China'}
        # print(person_2)

        # Hardcoded without using format_data() fx
        ...
        guess: str = input("Who has more followers? Type 'A' or 'B': ").upper()[0]
...
# Note: Solution created a fx format_data instead of my hardcoding similar to __repr__()
