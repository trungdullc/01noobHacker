# Day 015
# Lesson: Seperate each action into different functions but not classes yet
```python
...
# Note: DataType is dict[dict[dict]] and dict[dict] so can't use type annotation ❤️❤️❤️❤️❤️
MENU = {
    "espresso": {
        "ingredients": {
            "water": 50,
