# [74. Search a 2D Matrix](https://leetcode.com/problems/search-a-2d-matrix) ⭐⭐⭐⭐⭐❤️❤️❤️❤️❤️
...
class Solution:
   """
   A class to search for a target value in a 2D matrix using binary search.
   """

   def searchMatrix(self, matrix: list[list[int]], target: int) -> bool:
      """
      Determines if the target exists in the matrix.
      
      Args:
         matrix (list[list[int]]): A 2D matrix with sorted rows and ordered row starts.
