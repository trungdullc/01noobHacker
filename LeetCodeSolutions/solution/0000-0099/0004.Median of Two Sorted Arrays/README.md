# [4. Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays) ⭐⭐⭐⭐⭐❤️❤️❤️❤️❤️
...
class Solution:
   """
   A class to find the median of two sorted arrays in O(log(min(m, n))) time.
   """
...
[Continue 1095: Find in Mountain Array](../../1000-1099/1095.Find%20in%20Mountain%20Array/README.md)