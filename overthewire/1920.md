...
## Solution
```
@trungdullc ➜ /workspaces/01noobHacker (main) $ ssh bandit20@bandit.labs.overthewire.org -p 2220
bandit20@bandit:~$ ls -lah suconnect 
-rwsr-x--- 1 bandit21 bandit20 16K Jul 28 19:03 suconnect
bandit20@bandit:~$ whatis ssh nc cat bash screen tmux
...
bandit20@bandit:~$ ./suconnect 8080   # Do 2nd      │bandit20@bandit:~$ nc -lnvp 8080     # Do 1st
...
bandit20@bandit:~$                                  │0qXahG8ZjOVMN9Ghs7iOWsCfZyXOUbYO     # Do 3rd
                                                    │EeoULMCra2q0dSkYj561DX7s1CpBuOBt
                                                    │bandit20@bandit:~$ exit

bandit20@bandit:~$ echo -n '0qXahG8ZjOVMN9Ghs7iOWsCfZyXOUbYO' | nc -l -p 8080 &
[1] 718506
bandit20@bandit:~$ id
...
bandit20@bandit:~$ ./suconnect 8080                   # Note: Forgot -l so need do right away
Could not connect
bandit20@bandit:~$ echo -n '0qXahG8ZjOVMN9Ghs7iOWsCfZyXOUbYO' | nc -l -p 8080 &
[1] 918058
