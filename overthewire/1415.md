...
## Solution
```
@trungdullc ➜ /workspaces/01noobHacker (main) $ ssh bandit15@bandit.labs.overthewire.org -p 2220
bandit15@bandit:~$ whatis ssh telnet nc ncat socat openssl s_client  nmap netstat ss
