# picoGym Level 115: Wireshark doo dooo do doo...
Source: https://play.picoctf.org/practice/challenge/115

## Goal
Can you find the flag? shark1.pcapng.<br>
https://mercury.picoctf.net/static/0505a462ac9beb7412596855df280f6b/shark1.pcapng

## What I learned
```
wireshark RE, assume picoCTF{ means 7 letters followed by special char {
Filter: frame matches "[a-zA-Z]{7}\\{"
```
...
# Start at Statistics: Protocol Hierachy
# Note: Transmission Control Protocol: Hypertext Transfer Protocol contains high Percent Bytes
# Right Click: Apply as Filter → Selected

Filter: tcp contains "picoCTF" ⌨️
Results: None
Filter: http.response.code == 200 ⌨️
Results: To much but see ok on one

# Analyze Follow TCP Stream
# Note: Stream 5 contains some text/html
GET / HTTP/1.1
Host: 18.222.37.134
...
# Side View
Filter: tcp.stream eq 5 ⌨️
819	7.137396	192.168.38.104	18.222.37.134	TCP	66	64093 → 80 [SYN] Seq=0 Win=62727 Len=0 MSS=8961 WS=256 SACK_PERM
821	7.186705	18.222.37.134	192.168.38.104	TCP	66	80 → 64093 [SYN, ACK] Seq=0 Ack=1 Win=62727 Len=0 MSS=1460 SACK_PERM WS=128
...
# Method 2: Regular Expression in Filter
Filter: frame matches "[a-zA-Z]{7}\\{" ⌨️❤️❤️❤️❤️❤️
Filter: http matches "[a-zA-Z]{7}\\{" ⌨️
827	7.236537	18.222.37.134	192.168.38.104	HTTP	384	HTTP/1.1 200 OK  (text/html)
