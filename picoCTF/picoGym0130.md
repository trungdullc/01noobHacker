# picoGym Level 130: MacroHard WeakEdge
...
## What I learned
```
PowerPoint files are actually ZIPs

# Check for macros
AsianHacker-picoctf@webshell:~$ olevba "Forensics is fun.pptm" 
-bash: olevba: command not found
```
...
AsianHacker-picoctf@webshell:~$ wget https://mercury.picoctf.net/static/52da699e0f203321c7c90ab56ea912d8/Forensics%20is%20fun.pptm ⌨️
--2025-09-16 18:05:23--  https://mercury.picoctf.net/static/52da699e0f203321c7c90ab56ea912d8/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm                                      100%[======================================================================================================================================>]  97.75K  --.-KB/s    in 0.04s   

2025-09-16 18:05:23 (2.25 MB/s) - 'Forensics is fun.pptm' saved [100093/100093]

AsianHacker-picoctf@webshell:~$ file Forensics\ is\ fun.pptm ⌨️
Forensics is fun.pptm: Microsoft PowerPoint 2007+
AsianHacker-picoctf@webshell:~$ strings "Forensics is fun.pptm" | grep "picoCTF" ⌨️
AsianHacker-picoctf@webshell:~$ exiftool "Forensics is fun.pptm" ⌨️
ExifTool Version Number         : 12.40
File Name                       : Forensics is fun.pptm
Directory                       : .
File Size                       : 98 KiB
File Modification Date/Time     : 2021:03:24 02:34:02+00:00
File Access Date/Time           : 2025:09:16 18:05:49+00:00
File Inode Change Date/Time     : 2025:09:16 18:05:23+00:00
...
# Method 1: unzip
AsianHacker-picoctf@webshell:~$ unzip "Forensics is fun.pptm" ⌨️
...
AsianHacker-picoctf@webshell:~$ cd ppt/slideMasters/ ⌨️
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ ls ⌨️
_rels  hidden  slideMaster1.xml
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ file hidden ⌨️ 
hidden: ASCII text, with no line terminators
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ cat hidden ⌨️
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q 👀
AsianHacker-picoctf@webshell:~$ python3 -c "print(''.join('Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q'.split(' ')))" ⌨️
ZmxhZzogcGljb0NURntEMWRfdV9rbjB3X3BwdHNfcl96MXA1fQ
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ echo "ZmxhZzogcGljb0NURntEMWRfdV9rbjB3X3BwdHNfcl96MXA1fQ" | base64 -d ⌨️
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: invalid input 🔐
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ cat hidden | tr -d ' ' | base64 -d ⌨️
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: invalid input 🔐
AsianHacker-picoctf@webshell:~/ppt/slideMasters$ tr -d ' ' < hidden | base64 -d ⌨️
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: invalid input 🔐

# Method 2: binwalk -e
AsianHacker-picoctf@webshell:~$ binwalk -e Forensics\ is\ fun.pptm ⌨️
...
AsianHacker-picoctf@webshell:~$ cd "_Forensics is fun.pptm.extracted"/ ⌨️
AsianHacker-picoctf@webshell:~/_Forensics is fun.pptm.extracted$ ls ⌨️
 0.zip  '[Content_Types].xml'   _rels   docProps   ppt
AsianHacker-picoctf@webshell:~/_Forensics is fun.pptm.extracted$ cd ppt/slideMasters/ ⌨️
AsianHacker-picoctf@webshell:~/_Forensics is fun.pptm.extracted/ppt/slideMasters$ ls ⌨️
_rels  hidden  slideMaster1.xml
AsianHacker-picoctf@webshell:~/_Forensics is fun.pptm.extracted/ppt/slideMasters$ cat hidden ⌨️
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q 👀
AsianHacker-picoctf@webshell:~/_Forensics is fun.pptm.extracted/ppt/slideMasters$ cat hidden | tr -d ' ' | base64 -d ⌨️
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: invalid input 🔐
```
