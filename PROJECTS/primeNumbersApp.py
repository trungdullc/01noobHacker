...
divisible by one and themselves. They are used in a variety of practical applications.
...
def isPrime(number):
    ...
    # Try to evenly divide number by all numbers from 2 up to number's square root
