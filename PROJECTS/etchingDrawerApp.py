...
Level: Intermediate
What I learned:
    builtins.str.endswith('.txt')
    moves is a list[str]
    canvasStr is a str that gets printed
"""
...
CANVAS_WIDTH, CANVAS_HEIGHT = shutil.get_terminal_size()        # Get the size of the terminal window
    ...
    while True:                                         # Main program loop
        ...
        if response.startswith("Q"):
            ...
            try:
                ...
                if not filename.endswith('.txt'):       # ❤️
                    filename += '.txt'
