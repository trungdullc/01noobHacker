...
What I learned:
    ...
    The logic for how counter controls 0/1 is advance
"""
...
WIDTH = shutil.get_terminal_size()[0]   # ❤️
# Can't print last column on Windows without it adding a newline automatically, so reduce width by one
WIDTH -= 1
