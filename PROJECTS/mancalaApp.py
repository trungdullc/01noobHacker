...
''')
    ...
    while True:                             # Run a player's turn
        # "Clear" the screen by printing many newlines, so the old board isn't visible anymore
        print('\n' * 60)
...
def displayBoard(board):
    ...
    seedAmounts = []
    # This 'GHIJKL21ABCDEF' string is the order of the pits left to right and top to bottom
