...
BLANK = '  '                                        # Note: This string is two spaces
...
back into their original order:
    ...
    def askForPlayerMove(self, board):
        ...
        blankx, blanky = self.findBlankSpace(board)
    ...
    def makeMove(self, board, move):
        ...
        bx, by = self.findBlankSpace(board)
    ...
    def makeRandomMove(self, board):
        ...
        self.makeMove(board, random.choice(validMoves))

    def getNewPuzzle(self, moves=200):
