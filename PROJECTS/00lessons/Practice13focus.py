...
class MyApp(tkinter.Frame):
    def __init__(self, master = None):                      # master = None
        tkinter.Frame.__init__(self, master)                # Note: Can't do .__init__(master)
        
        self.master.title("lb to kg converter")             # Important: Found way to edit attributes in Frame class ❤️
