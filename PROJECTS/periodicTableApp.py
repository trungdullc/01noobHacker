...
import csv, sys, re                                                     # re is regular expression

# Read in all the data from data/periodictable.csv
elementsFile = open('data/periodictable.csv', encoding='utf-8')         # Note: encoding, could of used with
elementsCsvReader = csv.reader(elementsFile)                            # used csv import to read csv file but pandas is easier
...
for line in elements:
    ...
    for key, value in element.items():
        ...
        element[key] = re.sub(r'\[(I|V|X)+\]', '', value)   # ❤️
