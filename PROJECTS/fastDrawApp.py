"""
Fast Draw
Test your reflexes to see if you're the fastest draw in the 
...
def main():
    ...
    while True:
        ...
        time.sleep(random.randint(20, 50) / 10.0)       # Main logic of game
        print('DRAW!')

        drawTime = time.time()                          # Gets current time
        input()
