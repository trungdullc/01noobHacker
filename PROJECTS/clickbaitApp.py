...
A clickbait headline generator for your soulless content farm website (Mad Libs–style template)

Level: Beginner
What I learned:
    random.choice(my_choice) easier to read than my_choice[randint(0,len() -1)]
"""
